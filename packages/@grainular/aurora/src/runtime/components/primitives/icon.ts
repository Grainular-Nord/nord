...
const icons: Record<AuroraIconName, () => ComponentFragment> = {
    discord: () => html`
        <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <path
                d="M7 5.5c-2 2.8-2.5 5.6-2 8.5 1.8 2 3.6 3.1 5.4 3.5l1.1-1.5h1l1.1 1.5c1.8-.4 3.6-1.5 5.4-3.5.5-2.9 0-5.7-2-8.5l-3-1-1 1h-2l-1-1-3 1Z"
            ></path>
        </svg>
    `,
    github: () => html`
        <svg viewBox="0 0 24 24" aria-hidden="true">
            <path
                d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3.3-.4 6.8-1.6 6.8-7.4A5.7 5.7 0 0 0 19.3 3 5.3 5.3 0 0 0 19.1 0S17.9-.4 15 1.6a13.4 13.4 0 0 0-7 0C5.1-.4 3.9 0 3.9 0a5.3 5.3 0 0 0-.2 3A5.7 5.7 0 0 0 2.2 7.1c0 5.8 3.5 7 6.8 7.4A4.8 4.8 0 0 0 8 18v4"
            ></path>
        </svg>
    `,
    menu: () => html`
