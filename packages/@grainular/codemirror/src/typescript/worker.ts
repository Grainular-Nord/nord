// The worker is bundled separately from the TypeScript service.
...
// A deliberately small ambient library gives the worker useful Nørd hints
// without shipping every DOM declaration into the playground bundle.
...
/** Reconciles the virtual file system and bumps versions for changed files only. */
